...
- 聊天界面：浏览器打开 http://127.0.0.1:8081
- API 文档（开发模式）：http://127.0.0.1:8081/docs
...
开发模式下访问 http://127.0.0.1:8081/docs 可查看完整的 Swagger 交互式文档。
...
```bash
curl -X POST http://localhost:8081/api/v1/tenant/create \
  -H "Content-Type: application/json" \
